...
class OrchestratorConfig(BaseModel):
    ...
    system_prompt: str = Field(
        ...
        "- set_title_doc: Set the title of the document\n"
        "- read_title_doc: Read the title of the document\n"
        "- save_doc: Save the current document\n"
        "- remove_doc: Remove the current document\n"
        "- add_to_page: Add content to current page (append)\n"
        "- rewrite_page: Rewrite all the content of the current page\n"
        "- set_title_page: Set the title page content of the document\n"
        "- read_title_page: Read the title page of the document\n"
        "- next_page: Navigate to the next page in the document\n"
        "- prev_page: Navigate to the previous page in the document\n"
        "- read_page: Read content of the current page\n"
        "- delete_page: Delete the current or specified page from the document\n"
        "- reply_user: Just reply to user with content, not make any action to the document\n\n"
